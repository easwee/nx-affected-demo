...
const addE2eImplicitDependencies = (tree) => (0, ast_utils_1.updateJsonInTree)('workspace.json', // ngcli-adapter should handle conversion of workspace file names
(json) => {
...
function default_1() {
    return (0, schematics_1.chain)([showInfo, addE2eImplicitDependencies, (0, format_files_1.formatFiles)()]);
}

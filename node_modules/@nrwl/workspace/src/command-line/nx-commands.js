...
${daemonHelpOutput}
  `.trimRight()
    ...
    .command('affected:dep-graph', chalk.bold('Graph dependencies affected by changes'), (yargs) => linkToNxDevAndExamples(withAffectedOptions(withDepGraphOptions(yargs)), 'affected:dep-graph'), (args) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
...
`.trimRight()), (yargs) => linkToNxDevAndExamples(withDaemonStartOptions(yargs), 'daemon'), (args) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./daemon'))).daemonHandler(args); }))
    .command('dep-graph', chalk.bold('Graph dependencies within workspace'), (yargs) => linkToNxDevAndExamples(withDepGraphOptions(yargs), 'dep-graph'), (args) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./dep-graph'))).generateGraph(args, []); }))
    ...
    .command('workspace-lint [files..]', chalk.bold('Lint workspace or list of files.  Note: To exclude files from this lint rule, you can add them to the `.nxignore` file'), noop, (_) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./lint'))).workspaceLint(); }))

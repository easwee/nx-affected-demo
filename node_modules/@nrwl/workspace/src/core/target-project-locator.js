...
class TargetProjectLocator {
    constructor(nodes, externalNodes) {
        ...
        this.sortedProjects = (0, project_graph_1.getSortedProjectNodes)(this.nodes);
        this.sortedWorkspaceProjects = this.sortedProjects.map((node) => (Object.assign(Object.assign({}, node), { data: Object.assign(Object.assign({}, node.data), { normalizedRoot: (0, file_utils_1.normalizedProjectRoot)(node) }) })));

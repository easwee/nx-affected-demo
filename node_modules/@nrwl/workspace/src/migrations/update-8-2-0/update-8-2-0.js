...
const addExcludes = (0, workspace_1.updateWorkspace)((workspace) => {
    workspace.projects.forEach((project) => {
        project.targets.forEach((target) => {
            if (target.builder !== '@angular-devkit/build-angular:tslint') {
                return;
            }
            const exceptRootGlob = `!${(0, core_1.join)((0, core_1.normalize)(project.root), '**/*')}`;
...
function default_1() {
    return (0, schematics_1.chain)([addExcludes, (0, workspace_2.formatFiles)()]);
}

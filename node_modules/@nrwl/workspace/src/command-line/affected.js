...
function affected(command, parsedArgs) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const env = (0, file_utils_1.readEnvironment)(nxArgs.target, projectsNotExcluded);
            ...
            switch (command) {
                ...
                case 'print-affected':
                    if (nxArgs.target) {
                        ...
                        (0, print_affected_1.printAffected)(projectsWithTarget, filteredProjects, projectGraph, env, nxArgs, overrides);
                    }
                    else {
                        (0, print_affected_1.printAffected)([], filteredProjects, projectGraph, env, nxArgs, overrides);
                    }
                    break;
                case 'affected': {
                    const projectsWithTarget = allProjectsWithTarget(filteredProjects, nxArgs);
                    (0, run_command_1.runCommand)(projectsWithTarget, projectGraph, env, nxArgs, overrides, nxArgs.hideCachedOutput ? 'hide-cached-output' : 'default', null);
                    break;
                }
            }
        }
...
function projectsToRun(nxArgs, projectGraph) {
    ...
    let affectedGraph = nxArgs.all
        ? projectGraph
        : (0, affected_project_graph_1.filterAffected)(projectGraph, (0, file_utils_1.calculateFileChanges)((0, shared_1.parseFiles)(nxArgs).files, nxArgs));
    if (nxArgs.withDeps) {

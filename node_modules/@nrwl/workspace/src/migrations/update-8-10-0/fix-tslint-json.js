...
function fixTslints(host) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        workspace.projects.forEach((proj) => {
            const tslintPath = (0, core_1.join)((0, core_1.normalize)(proj.root), 'tslint.json');
            if (host.exists(tslintPath)) {
                rules.push((0, ast_utils_1.updateJsonInTree)(tslintPath, (json, context) => {
        ...
        rules.push((0, workspace_2.formatFiles)());
...
function default_1() {
    return (0, schematics_1.chain)([showInfo, fixTslints]);
}

...
class Cache {
            ...
            return this.tryAndRetry(() => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield Promise.all(outputs.map((f) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    if (yield existsAsync(src)) {
                        ...
                        const directory = isFile ? (0, path_1.resolve)(cached, '..') : cached;
                        yield (0, fs_extra_1.ensureDir)(directory);
                        yield (0, fs_extra_1.copy)(src, cached);
                    }
                })));
            ...
            return this.tryAndRetry(() => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield Promise.all(outputs.map((f) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    if (yield existsAsync(cached)) {
                        ...
                        const src = (0, path_1.join)(this.root, f);
                        yield (0, fs_extra_1.remove)(src);
                        // Ensure parent directory is created if src is a file
                        const directory = isFile ? (0, path_1.resolve)(src, '..') : src;
                        yield (0, fs_extra_1.ensureDir)(directory);
                        yield (0, fs_extra_1.copy)(cached, src);
                    }
                })));
    ...
    recordOutputsHash(outputs, hash) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            for (const output of outputs) {
                const hashFile = this.getFileNameWithLatestRecordedHashForOutput(output);
                try {
                    yield (0, fs_extra_1.ensureDir)((0, path_1.dirname)(hashFile));
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            for (let output of outputs) {
                ...
                if ((yield existsAsync(cacheOutputPath)) &&
                    ...
                    return ((yield existsAsync((0, path_1.join)(cachedResult.outputsPath, output))) &&
                        !(yield existsAsync((0, path_1.join)(this.root, output))));
                }
    ...
    createCacheDir() {
        const dir = (0, cache_directory_1.cacheDirectory)(this.root, this.options.cacheDirectory);

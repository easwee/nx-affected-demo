...
function getPatternsFromApps(affectedFiles, matchAllPattern) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const affectedGraph = (0, affected_project_graph_1.filterAffected)(graph, (0, file_utils_1.calculateFileChanges)(affectedFiles));
...
function getPatternsFromProjects(projects, matchAllPattern) {
    const roots = (0, shared_1.getProjectRoots)(projects);

...
function buildEnvironmentJs(exclude, focus, groupByFolder, watchMode, localMode, depGraphClientResponse) {
    ...
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        if (args.file) {
            ...
            if (ext === '.html') {
                ...
                const depGraphClientResponse = yield createDepGraphClientResponse();
                const environmentJs = buildEnvironmentJs(args.exclude || [], args.focus || null, args.groupByFolder || false, args.watch, !!args.file && args.file.endsWith('html') ? 'build' : 'serve', depGraphClientResponse);
            ...
            const environmentJs = buildEnvironmentJs(args.exclude || [], args.focus || null, args.groupByFolder || false, args.watch, !!args.file && args.file.endsWith('html') ? 'build' : 'serve');

...
class TaskOrchestrator {
    ...
    applyCachedResult(task) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.options.lifeCycle.printTaskTerminalOutput(task, shouldCopyOutputsFromCache
                ? output_1.TaskCacheStatus.RetrievedFromCache
                : output_1.TaskCacheStatus.MatchedExistingOutput, cachedResult.terminalOutput);
            return task;
        });
    }
    ...
    postRunSteps(results, { groupId }) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield Promise.all(results
                ...
                .map((result) => (Object.assign(Object.assign({}, result), { code: result.status === 'cache' || result.status === 'success' ? 0 : 1, outputs: (0, utils_1.getOutputs)(this.projectGraph.nodes, result.task) })))

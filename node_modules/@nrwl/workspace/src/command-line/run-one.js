...
function runOne(opts) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const env = (0, file_utils_1.readEnvironment)(opts.target, projectsMap);
        (0, run_command_1.runCommand)(projects, projectGraph, env, nxArgs, overrides, 'run-one', opts.project);
    });
}

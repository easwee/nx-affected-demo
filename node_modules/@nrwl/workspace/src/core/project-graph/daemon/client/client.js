            ...
            return new Promise((resolve) => {
                const id = setInterval(() => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    if (yield isServerAvailable()) {
                        ...
                        throw daemonProcessException('Failed to start the Nx Daemon process.');
                    }
                    else {
                        attempts++;
                    }
            ...
            socket.on('connect', () => {
                ...
                socket.on('end', () => {
                    try {
                        ...
                        const projectGraphResult = (0, socket_utils_1.deserializeResult)(serializedProjectGraphResult);

...
const addEnforceBuildablePackageTslintRule = (host) => {
    if (host.exists('tslint.json')) {
        return (0, ast_utils_1.updateJsonInTree)('tslint.json', (json) => {
...
exports.addEnforceBuildablePackageTslintRule = addEnforceBuildablePackageTslintRule;
const addEnforceBuildablePackageEslintRule = (host) => {
    if (host.exists('.eslintrc')) {
        return (0, ast_utils_1.updateJsonInTree)('.eslintrc', (json) => {
...
exports.addEnforceBuildablePackageEslintRule = addEnforceBuildablePackageEslintRule;
function default_1() {

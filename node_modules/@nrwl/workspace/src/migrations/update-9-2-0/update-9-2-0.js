...
const updatePackages = (0, workspace_1.updatePackagesInPackageJson)((0, path_1.join)(__dirname, '../../../', 'migrations.json'), '9.2.0');
const addCacheableOperations = (0, workspace_1.updateJsonInTree)('nx.json', (nxJson) => {
...
function default_1() {
    return (0, schematics_1.chain)([updatePackages, addCacheableOperations, (0, workspace_1.formatFiles)()]);
}
